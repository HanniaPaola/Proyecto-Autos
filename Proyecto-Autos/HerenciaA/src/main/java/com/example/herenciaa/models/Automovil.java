...
public class Automovil {
    ...
    private static List<Automovil> listaAutomovils = new ArrayList<>();

    public Automovil(String nombreAuto, String idAuto, String modeloAuto, String fecha, double precio) {
    ...
    public static void agregarProductoLista(Automovil nuevoAutomovil) {
        listaAutomovils.add(nuevoAutomovil);
    }

    public static List<Automovil> obtenerListaProductos() {
        return listaAutomovils;
    }

    public void agregarProducto(Automovil nuevoAutomovil) {
        listaAutomovils.add(nuevoAutomovil);
    }
}
